...
// TODO: 
//#define						structdef(_name, _body) struct _name##__ _body; typedef struct name##__ _name
							 					   
#define						 ne_malloc(_size)	   malloc((_size)) // redefine, if you need.
#define						 ne_new(_type, _size)  ((_type *)ne_malloc(sizeof(_type) * _size))
